...
import { engagementPathSteps } from '../data/engagementPath'
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 max-w-2xl sm:mb-14">
          ...
          <p className="mt-5 text-lg leading-relaxed text-gray-600 dark:text-neutral-400">
            A clear path from first discussion to investor distribution —
            structured for asset managers bringing private market strategies to
            market.
          </p>
        </div>

        <div className="min-h-[640px] rounded-3xl border border-zinc-200/70 bg-neutral-950/95 p-4 sm:p-6 dark:border-white/10">
          <ChromaGrid items={engagementPathSteps} radius={280} className="py-2" />
        </div>
      </div>
    </section>
  )
