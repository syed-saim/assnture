  ...
  return (
    <section id="about" className="relative z-10 py-16 md:py-32">
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        <div className="mb-16">
          <h2 className="mb-6 text-4xl font-medium text-gray-800 md:text-5xl lg:text-6xl dark:text-neutral-100">
        ...
        <div className="rounded-2xl bg-white dark:bg-assnture">
          <div className="overflow-hidden rounded-lg border border-zinc-300/70 bg-white px-2 py-2 dark:border-white/20 dark:bg-neutral-950">
            <div className="grid grid-cols-1 gap-16 rounded-lg border border-zinc-300/70 bg-transparent px-8 py-16 text-center text-gray-800 md:grid-cols-3 md:px-12 md:py-20 dark:border-neutral-800 dark:text-gray-100">
              {companyStats.map((stat) => (
                <div key={stat.label}>
                  <div className="mb-4 flex items-center justify-center text-6xl font-medium lg:text-7xl">
                    {stat.value}
                  </div>
