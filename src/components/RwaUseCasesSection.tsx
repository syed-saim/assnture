...
import { rwaUseCases } from '../data/rwaUseCases'

export function RwaUseCasesSection() {
  return (
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 max-w-2xl sm:mb-14">
          ...
          <h2 className="text-3xl leading-tight font-medium text-gray-900 sm:text-5xl dark:text-neutral-100">
            RWA tokenization across industries
          </h2>
          <p className="mt-5 text-lg leading-relaxed text-gray-600 dark:text-neutral-400">
            From public finance to logistics, institutions can bring real-world
            assets on-chain with regulated issuance, distribution and settlement
            rails. Hover the grid to explore each sector.
          </p>
        </div>

        <div className="min-h-[640px] rounded-3xl border border-zinc-200/70 bg-neutral-950/95 p-4 sm:p-6 dark:border-white/10">
          <ChromaGrid items={rwaUseCases} radius={280} className="py-2" />
        </div>
      </div>
    </section>
  )
